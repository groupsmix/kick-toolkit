...
const navItems: NavItem[] = [
  ...
  { path: "/timed-messages", label: "Timed Messages", icon: Timer },
  { path: "/polls", label: "Chat Polls", icon: PollIcon },
  { path: "/predictions", label: "Predictions", icon: TrendingUp },
  { path: "/translation", label: "Translation", icon: Languages },
  { path: "/viewer-count", label: "Viewer Count", icon: Users },
  { type: "separator", label: "Gaming" },
  { path: "/game-queue", label: "Game Queue", icon: Gamepad2 },
  { path: "/match-history", label: "Match History", icon: Swords },
  { path: "/kd-counter", label: "K/D Counter", icon: Crosshair },
  { path: "/achievements", label: "Achievements", icon: Award },
  { path: "/game-challenges", label: "Challenges", icon: Target },
  { path: "/rank-tracker", label: "Rank Tracker", icon: TrendingUp },
  { type: "separator", label: "Gambling" },
  { path: "/gambling", label: "Gambling Tools", icon: DollarSign },
  { type: "separator", label: "IRL" },
  { path: "/irl", label: "IRL Tools", icon: MapPin },
  { type: "separator", label: "Creative" },
  { path: "/creative", label: "Creative Tools", icon: Palette },
];
